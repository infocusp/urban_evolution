...
"""
    ...
    st.table(df)
    st.image("urbanevo_streamlit/static/class_distribution.png")
    st.image("urbanevo_streamlit/static/label_main.png",caption="Ground truth labels spread in Northern India")
...
with tab_features:
     ...
     with col_terra:
        ...
        st.image("urbanevo_streamlit/static/TERRACLIMATE.png")
     ...
     with col2_modis:
        ...
        st.image("urbanevo_streamlit/static/MODIS_061.png")
        with st.expander("Bands Details"):
     ...
     with col_srtm:
        ...
        st.image("urbanevo_streamlit/static/srtm.png")
        with st.expander("Bands Details"):
     ...
     with col2_mcd:
        ...
        st.image("urbanevo_streamlit/static/MODIS_061_MCD12Q1_sample.png")
        with st.expander("Bands Details"):
     ...
     with col_pop:
        ...
        st.image("urbanevo_streamlit/static/CIESIN_GPWv411_GPW_Population_Density_sample.png")
        with st.expander("Bands Details"):
     ...
     with col2_build:
        ...
        st.image("urbanevo_streamlit/static/ghsl.png")
        with st.expander("Bands Details"):
...
with tab_corr:
    ...
    st.image("urbanevo_streamlit/static/featcorr.png")
...
with tab_storage:
    ...
    st.image("urbanevo_streamlit/static/dir.png")
