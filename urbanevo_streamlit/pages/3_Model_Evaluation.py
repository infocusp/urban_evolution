...
with tab_year_5:
    ...
    if option == 'Confusion Matrix':
        ...
        with col1:
            ...
            st.image("static/cm_lgbm_base_5.png")
        ...
        with col2:
            ...
            st.image("static/cm_lgbm_weight_5.png")
            with st.expander("Conclusion"):
        ...
        with col3:
            ...
            st.image("static/cm_lgbm_3_5year.png")
            with st.expander("Conclusion"):
        ...
        with col4:
            ...
            st.image("static/cm_lgbm_4_5year.png")
            with st.expander("Conclusion"):
        ...
        with col11:
            ...
            st.image("static/prec_mc.png")
        with col22:
            st.markdown("### Recall ###")
            st.image("static/recall_mc.png")
        with col33:
            st.markdown("### F1-Score ###")
            st.image("static/f1score_mc.png")
        ...
        with col111:
            st.markdown("### Precision ###")
            st.image("static/prec_yy5.png")
        with col222:
            st.markdown("### Recall ###")
            st.image("static/recall_yy5.png")
        with col333:
            st.markdown("### F1-Score ###")
            st.image("static/f1score_yy5.png")
...
with tab_year1:
    ...
    with col1_1:
            ...
            st.image("static/cc_1year.png")
    with col2_1:
            st.markdown("##### Precision #####")
            st.image("static/prec_1year.png")
    col3_1, col4_1  = st.columns(2)
    with col3_1:
            st.markdown("##### Recall #####")
            st.image("static/recall_1year.png")
    with col4_1:
            st.markdown("##### F1 Score #####")
            st.image("static/f1score_1year.png")